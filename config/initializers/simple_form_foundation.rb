...
SimpleForm.setup do |config|
  ...
  config.wrappers :hide_label_form, tag: 'div', class: 'row', hint_class: :field_with_hint, error_class: :error do |b|
    b.use :html5
    b.use :placeholder
    b.optional :maxlength
    b.optional :pattern
    ...
    b.wrapper :label_wrapper, tag: :div, class: 'hide' do |ba|
      ba.use :label, class: 'right inline'
    end

    b.wrapper :right_input_wrapper, tag: :div, class: 'small-12 columns' do |ba|
      ba.use :input
      ba.use :error, wrap_with: { tag: :small, class: :error }
      # ba.use :hint,  wrap_with: { tag: :span, class: :hint }
    end
    ...
    config.wrappers :hide_label_horizontal_radio_and_checkboxes, tag: 'div', class: 'row' do |b|
      b.use :html5
      b.optional :readonly
      # b.use :label, false
      b.wrapper :container_wrapper, tag: 'div', class: 'small-12 columns' do |ba|
        ba.wrapper :tag => 'label', :class => 'checkbox_container' do |bb|
          bb.use :input#, wrapper_html:{class: 'fdsf'})
          bb.use :label_text
        end
